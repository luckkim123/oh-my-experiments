...
from omx_core.profile import bootstrap_profile, validate_metrics_schema
...
def test_score_improvement_requires_formula():
    d = _good()
    d["keep_policy"] = "score_improvement"
    d["score_formula"] = None
