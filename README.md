...
OMX ships as a Claude Code plugin (marketplace `omx`, plugin `oh-my-experiments`).

```
/plugin marketplace add luckkim123/oh-my-experiments
/plugin install oh-my-experiments@omx
```

Once loaded, the four skills below auto-route from natural-language prompts ("analyze these
runs", "다음 실험 설계해줘").
